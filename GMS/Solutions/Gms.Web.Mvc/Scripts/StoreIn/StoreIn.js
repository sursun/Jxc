...
StoreIn.Init = function () {
    ...
    $("#btnAdd").click(function () {
        ...
        var vReturnValue = window.showModalDialog('/StoreIn/Add', '', features);
    ...
    $(".btnDetail").live("click", function () {
        ...
        window.showModalDialog('/StoreIn/Detail?id=' + nId, '', features);

    });

};

StoreIn.Audit = function () {
    ...
    $(".btnAudit").live("click", function () {
        ...
        $.post("/StoreIn/SaveAudit", { id: nId, pass: nPass }, function (data) {
            if (data.success) {
